...
static string matchFilePath;
static string chromDirPath;
...
bool handleArgs(int count, char* args[])
{
    ...
    if (vm.count("header") && !vm.count("file-input"))
    {
        ...
        if (verbose) cout << "Header: " << vm["header"].as<string>() << endl;
    }
    ...
    if (vm.count("chrom") && !vm.count("file-input"))
    {
        ...
        if (verbose) cout << "Chromosome: " << vm["chrom"].as<string>() << endl;
    }
    ...
    if (vm.count("coord") && !vm.count("input-file"))
    {
        ...
        if (verbose) cout << "Coordinate: " << vm["coord"].as<unsigned int>() << endl;
    }
    ...
    if (vm.count("bases"))
    {
        ...
        if (verbose) cout << "Bases: " << vm["bases"].as<unsigned int>() << endl;
    }
    else {
    ...
    if (vm.count("output-file"))
    {
        ...
        if (verbose) cout << "Out File: " << vm["output-file"].as<string>() << endl;
    }
    else
    {
